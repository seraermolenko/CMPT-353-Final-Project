...
# printing results
print("alpha = " + str(results.power_law.alpha))            # estimated tail index
print("x_min= " + str (results.power_law. xmin) )           # estimated x min value 
print('p= ' + str(compute_power_law_p_val(results)))        # p is a quility score of the pwer law fit is, between 0 and 1, the clsoer to 1, the better the fit 
