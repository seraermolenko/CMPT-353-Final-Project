...
try:
    ...
    plt.ylabel('Power-law Fit to Moby-Dick Distribution')
    plt.legend()
    ...
    if(R > 0):
        print("The data is more likely to be ", first_distribution, "\n")            
    elif(R == 0):
        print(f"The data is equally likley under both ", first_distribution, "and", second_distribution,"\n")
    else:
        print("The data is more likley to be ", second_distribution,"\n")


    # TESTING SIMULATING POWER LAW
